...
Window_find::Window_find(Database *_db, int _type, int _group, int *_index, QWidget *parent) : SmallWindow(parent)
{
...
Window_find::Window_find(Database *_db, int _type, int _group, float *_index, QWidget *parent) : SmallWindow(parent)
{
    setFixedSize(960, 900);
