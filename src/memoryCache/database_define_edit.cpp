...
void DB_bullet::toJson(int _group, QMap<int, int> map_text, QMap<int, int> map_hero, QMap<int, int> map_enemy, QMap<int, int> map_boss, QMap<int, int> map_bullet[],
 QMap<int, int> map_effect[], QMap<int, int> map_audio[], QMap<int, int> map_image[], QJsonObject *jObj)
{
